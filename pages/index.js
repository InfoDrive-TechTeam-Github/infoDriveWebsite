            ...
            <Grid container spacing={0}>
              ...
              <Grid item xs={7}>
                <Card>
                  <CardContent>
                    <Typography variant="body2" color="text.secondary">
                      Delivering our very best in all we do, holding ourselves accountable for results with a commitment to integrity, fairness and responsibility. <br/> <br/>
                    Our team of experienced developers uses the latest technologies to build custom software solutions that drive efficiency, improve the user experience, and support our clients' unique needs and goals.
                    </Typography>
