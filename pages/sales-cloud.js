    ...
    <div>
      ...
      <div className='sliderBox'>
        ...
        <Box sx={{ flexGrow: 1 }} className='sliderContent salePart'>
          <Grid container spacing={0}>
            <Typography gutterBottom variant='h3' component='div'>Salesforce Sales Cloud Services
            </Typography>
            <Typography gutterBottom variant='h1' component='div'>
            At InfoDrive Solutions, we specialize in <br/>
            the implementation and consulting of <br/>
            Salesforce Sales Cloud, the world's <br/>
      ...
      <section className={`sectionBox`}>
        <Typography gutterBottom variant='h2' component='div'>
          We have a team of certified Salesforce consultants who have extensive experience in helping businesses streamline their sales processes and drive growth through the use of Salesforce Sales Cloud.
        </Typography>

        <Typography gutterBottom variant='h5' component='div'>
        Salesforce Sales Cloud is a powerful tool that can help your business manage customer interactions and data throughout the customer lifecycle, from lead generation to conversion and retention.  With its customizable interface and robust feature set, Salesforce Sales Cloud can be tailored to meet the specific needs of your business. We offer Salesforce Sales Cloud implementation and consulting services in Singapore, Malaysia, and India. Our team of certified Salesforce consultants has extensive experience in helping businesses in these regions streamline their sales processes and drive growth through the use of Salesforce Sales Cloud.        </Typography>
      </section>
            ...
            <Grid item xs={6} className>
              <Card>
                <CardContent>
                  ...
                  Before we begin the implementation process, we'll work with you to understand your business needs and goals. This will help us tailor the solution to meet your specific requirements and ensure that it aligns with your overall business strategy.                  </Typography>
                </CardContent>
              </Card>
            </Grid>
            ...
            <Grid item xs={6}>
              <Card>
                <CardContent>
                  ...
                  Our team will help you set up your Salesforce account and configure it to your specific needs. This includes customizing fields, workflows, and other settings to ensure that the platform is optimized for your business.                  </Typography>
                </CardContent>
              </Card>
            </Grid>
            ...
            <Grid item xs={6}>
              <Card>
                <CardContent>
                  ...
                  <br />
                  <Typography className="pr30" variant='body2' color='text.secondary'>
                  If you're moving from a different CRM platform or have data stored in other systems, we can help you migrate and integrate that data into Salesforce Sales Cloud. This will help ensure that you have a comprehensive view of your customer data and can take full advantage of the platform's features.                  </Typography>
                </CardContent>
              </Card>
            </Grid>
            ...
            <Grid item xs={6}>
              <Card>
                <CardContent>
                  ...
                  <br />
                  <Typography variant='body2' color='text.secondary'>
                  Our team will provide training and support to help you and your team get up to speed with Salesforce Sales Cloud. We'll also be available to answer any questions and provide ongoing support as you continue to use the platform.                  </Typography>
                </CardContent>
              </Card>
            </Grid> 
          </Grid>
