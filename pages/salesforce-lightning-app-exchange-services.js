  ...
  return (
    <div>
      ...
      <section className="newsectionbox   text-white relative  ocean pb-0 h-screen ">
        ...
        /> */}
        <img alt="hero" src="./appExchange.png" className="w-full" />
        <div className="container md:max-w-5xl  lg:max-w-7xl mx-auto    h-full w-full  p5 absolute top-16 md:top-40 md:left-10  px-4  lg:px-8">
      ...
      >
        ...
        <div className="container mx-auto px-8 p5">
      ...
      <section className={`newsectionbox p5  h-full -mt-10 space-y-5`}>
        <div className="container px-8 mx-auto    h-full w-full  ">
          <h2 style={{ zIndex: 5 }} className="text-justify">
      ...
      <section className={`newsectionbox p5 relative h-full -mt-10 space-y-5`}>
        ...
        <div className="container  mx-auto    h-full w-full px-8 p5  ">
          <div className="flex items-center gap-10 ">
            ...
            <div className="left space-y-5 w-1/2">
              ...
              <h5>
                At InfoDrive Solutions, we offer an extensive range of
                Salesforce AppExchange development services, backed by a team of
                highly experienced and certified Salesforce Consultants. Our
                dedicated experts are always ready to assist you in creating and
                publishing your standalone apps on this platform. Leveraging
                powerful APIs, Lightning components, and mobile-ready tools, we
                guide you through the entire process of AppExchange product
                design, development, review, and publication.
              </h5>
            </div>
            {/* right */}
            <div className="right h-96 rounded-md overflow-hidden">
      ...
      <section className="newsectionbox ">
        <div className="container mx-auto px-8 -mt-24">
          <div className="relative self-start ml-10 flex items-center justify-between ">
              ...
              <Card>
                <CardContent>
                  ...
                  >
                    ...
                    where experience meets expertise to help businesses optimize
                    their{" "}
                    <span className="text-red-600 font-bold">
                      Lightning and AppExchange services,
                    </span>{" "}
                    fostering growth in these vital areas. We specialize in the
                    implementation and consulting of Salesforce Lightning
                    Solutions AppExchange Services, globally acknowledged as the
