  ...
  return (
    <div>
      <Head>
        ...
        <meta
          property="og:title"
          content="Empower Your Business with Salesforce Commerce Cloud - InfoDrive Solutions"
        />
        <meta
          property="og:image"
      ...
      >
        ...
        <div className=" container mx-auto md:px-8 p5 ">
          <h2
            ...
            style={{ color: "#dd3952" }}
          >
            WHY InfoDrive Solutions for Salesforce Commerce Cloud ?
          </h2>
          <p className="mt-5 text-center text-gray-600 ">
            InfoDrive benefits for the Salesforce Commerce Cloud help you drive innovation to your sales, marketing,
