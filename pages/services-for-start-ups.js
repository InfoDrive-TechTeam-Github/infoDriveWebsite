...
export default function ServicesForStartUps() {
  return (
    ...
    <div>
    ...
    </section><section className={`sectionBox ourValueBox`}>
        <Box sx={{ flexGrow: 1 }}>
          <Grid container spacing={0}>
            <Grid item xs={6}>
              <Typography
          ...
          <Grid container spacing={0}>
            <Grid item xs={6}>
              <Typography gutterBottom variant='h5' component='div'>
                ...
                challenges faced with the fast pace of technology development as
                well as the growth of well-known companies in the market.
              </Typography>
            </Grid>
            <Grid item xs={6}>
              <Typography gutterBottom variant='h5' component='div'>
                Employing the services provided by software development
                outsourcing vendors like us will allow start-ups to have better
                technical execution, by ensuring product quality is ready for
      ...
      </section><section className={`sectionBox connectUs backDrop`}>
        <Typography
          gutterBottom
          variant='h3'
      ...
      </section><section className={`sectionBox whyUsBox`}>
