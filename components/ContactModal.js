...
<input placeholder='full name' className='border border-gray-300 rounded-md p-2' name='full_name' onChange={handleChange}/>
<input placeholder='Email Address' className='border border-gray-300 rounded-md p-2' name='email_address' onChange={handleChange}/>
<input placeholder='Contact Number' className='border border-gray-300 rounded-md p-2' name='contact_number' onChange={handleChange}/>
<textarea placeholder='message' className='border border-gray-300 rounded-md p-2' name='message' cols={25} onChange={handleChange}/>
{/* <ReCAPTCHA
    sitekey="6LcqzWEpAAAAALwrGPJ7XPd3Z9sMfIGci_V-SfOM"
    onChange={onChange}
  /> */}
  <button className='p-2 text-white shadow-md bg-red-600 rounded-md' onClick={handleSubmit}>Send Message</button>
